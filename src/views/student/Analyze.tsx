  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="bg-white p-10 rounded-xl border-dashed border-2 border-[#e7e5e4] flex flex-col items-center justify-center gap-6 text-center hover:border-[#1a237e] transition-all group">
        ...
        {file && (
          <div className="flex items-center gap-2 text-[#2b8a3e] bg-emerald-50 border border-emerald-100 px-4 py-2 rounded-lg text-xs font-bold shadow-sm animate-in fade-in slide-in-from-bottom-2">
      ...
      <div className="bg-white p-6 rounded-xl border border-[#e9ecef] shadow-sm space-y-2">
        <label className="text-[10px] font-black uppercase tracking-widest text-[#57534e] pl-1">Extra Information (Optional)</label>
        <textarea 
          value={extraInfo}
