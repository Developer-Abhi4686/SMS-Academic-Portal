    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-[#57534e] text-[11px] font-bold uppercase tracking-widest">Help with homework in simple, grade-appropriate language.</p>
        </div>
      </div>

      <div className="bg-white p-6 rounded-xl border border-[#e9ecef] shadow-sm space-y-4">
        <div className="space-y-1">
          <label className="text-[10px] font-black uppercase tracking-widest text-[#57534e] pl-1">Homework Details</label>
          <textarea 
            value={content}
        ...
        <div className="flex gap-4">
          <button 
            type="button"
            className="flex-1 bg-[#fdfcfb] border border-[#e7e5e4] hover:bg-blue-50 rounded-lg py-3 flex items-center justify-center gap-2 text-[#57534e] font-black text-[10px] uppercase tracking-widest transition-all"
          >
        ...
        >
          {loading ? <RotateCcw className="w-4 h-4 animate-spin text-[#f59e0b]" /> : <> <Send className="w-4 h-4 text-[#f59e0b]" /> Help with Assignment </>}
        </button>
      </div>
      ...
      <div className="p-4 bg-blue-50 border border-blue-100 rounded-xl text-[#1a237e] text-[10px] font-bold uppercase tracking-wider text-center">
